...
KOBO_CSV_URL = "https://kf.kobotoolbox.org/api/v2/assets/anTzKoStY8UQ8usgE2g9hb/export-settings/esY5wmpw98hW3i6LZvHKXho/data.csv"
...
if response.status_code == 200:
    ...
    insert_query = f"""
        INSERT INTO {schema_name}.{table_name} (
            "start", "end", "date", country, event, oblast, casualties, 
            injured, captured, civilian_casualties, new_recruits, combat_intensity,
            territory_status, percentage_occupied, area_occupied, total_casualties 
